...
<div class="max-w-7xl mx-auto p-6">
                ...
                @forelse($backups as $backup)
                    ...
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <form action="{{ route('backup.delete', ['filename' => $backup['filename']]) }}"
                                  method="POST"
                                  class="inline-block ml-2"
    ...
    <div class="mt-6 bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
        <p class="text-sm text-yellow-800">
            ...
            بازیابی بکاپ تمام داده‌های فعلی را جایگزین می‌کند.
            قبل از بازیابی، از داده‌های فعلی بکاپ بگیرید.
        </p>
    </div>
